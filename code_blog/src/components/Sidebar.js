...
const Sidebar = ({ author, authorFluid }) => (
    <div>
                ...
                <CardBody>
                    ...
                    <div className="author-social-links text-center">
                        <ul>
                            ...
                            <li><a href={author.googlek} target="_blank" rel="noopener noreferrer" className="google"><i className="fab fa-google fa-lg"></i></a></li>
        ...
        <Card>
            <CardBody>
                ...
                <Form className="text-center">
                    ...
                    <button className="btn btn-outline-success text-uppercase">Subcribe</button>
                </Form>
            </CardBody>
        </Card>
        <Card>
        ...
        <Card>
            <CardBody>
                <CardTitle className="text-center text-uppercase mb3">
                    Recent Posts
                </CardTitle>
